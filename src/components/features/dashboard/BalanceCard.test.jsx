...
describe('BalanceCard', () => {
  it('renders balance, invested, and returns in Argentine format', () => {
    render(<BalanceCard balance={10000} totalInvested={8000} returns={25} />);

    expect(screen.getByText('USD 10.000,00')).toBeInTheDocument();
    expect(screen.getByText('USD 8.000,00')).toBeInTheDocument();
    expect(screen.getByText('+25,00%')).toBeInTheDocument();
  });

  it('renders negative returns in red', () => {
    render(<BalanceCard balance={7000} totalInvested={8000} returns={-12.5} />);
  ...
  it('renders positive returns in green', () => {
    render(<BalanceCard balance={12000} totalInvested={8000} returns={50} />);
