    ...
    translation: {
      ...
      dashboard: {
        ...
        kpis: {
          ...
          strategyReturnYtdUsd: `Resultado anual ${getCurrentYear()} (USD)`,
          strategyReturnYtdPct: `Resultado anual ${getCurrentYear()} (%)`,
          strategyReturnAllUsd: 'Resultado acumulado (USD)',
          strategyReturnAllPct: 'Resultado acumulado (%)',
    ...
    translation: {
      ...
      dashboard: {
        ...
        kpis: {
          ...
          strategyReturnYtdUsd: `Annual return ${getCurrentYear()} (USD)`,
          strategyReturnYtdPct: `Annual return ${getCurrentYear()} (%)`,
          strategyReturnAllUsd: 'Cumulative return (USD)',
          strategyReturnAllPct: 'Cumulative return (%)',
